...
describe('NewRestaurantForm', () => {
  ...
  describe('when filled in', () => {
    beforeEach(async () => {
      ...
      //Avoid warning when updating the component state asynchronously
  ...
  describe('when correcting a validation error', () => {
    beforeEach(async () => {
      ...
      // To avoid moving on and interacting again with the component to early
  ...
  describe('when the store action rejects', () => {
    ...
    it('does not clears the name', () => {
      const {queryByPlaceholderText} = context;
      expect(queryByPlaceholderText('Add Restaurant').value).toEqual(
        restaurantName,
      );
    });
  });
